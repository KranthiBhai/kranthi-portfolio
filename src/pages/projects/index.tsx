        ...
        <div className=' w-full min-h-[90vh] bg-clr2/60'>
          ...
          <div className=' flex flex-col-reverse gap-y-10 my-10'>
            {propjectsData.map((item, index) => {
              return (
                <div key={index} className=" rounded-lg shadow-2xl bg-gray-100 w-2/3 mx-auto min-h-[15rem] flex">
                  {/* text */}
                  ...
                  <div className=' w-1/2 min-h-[15rem] h-full'>
                    <a href={item.href} target="_blank" className=' min-h-[15rem] h-full'>
                      <img src={item.image} alt="img" className=' min-h-[15rem] h-full object-cover' />
                    </a>
                  </div>
                </div>
              );
